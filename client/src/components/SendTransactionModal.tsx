...
export const SendTransaction = () => {
  ...
  return (
    <>
      ...
      >
        <div className="hs-overlay-open:opacity-100 hs-overlay-open:duration-500 opacity-100 transition-all w-full mx-auto flex flex-col h-full items-center justify-center">
